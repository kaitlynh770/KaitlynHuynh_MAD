...
//        introText.isHidden = true
    ...
    func finishQuiz(){
        if questionsAnswered == 10{
            ...
            nextQuestionButton.isHidden = true;
            introText.text = "You got " + finalScore + " out of " + totalQuestions;
    ...
    func randomQuestions(){
        ...
        switch(randomNumber){
            case 1:
                ...
                introText.text = "Who is associated with this ghost?"
            ...
            case 2:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who is an Electro user?"
            ...
            case 3:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who can use this weapon?"
            ...
            case 4:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who is a Hydro user?"
                questionImage.image = UIImage(named: "hydro-vision")
            ...
            case 5:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who is a Geo user?"
            ...
            case 6:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who is the consultant for the Wangsheng Funeral Parlor?"
            ...
            case 7:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who's constellation is this?"
            ...
            case 9:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who is an Anemo user?"
            ...
            case 10:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who's favorite food is this?"
            ...
            case 12:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who's signature dish is this?"
            ...
            case 13:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who can't handle spicy food?"
            ...
            case 15:
                resetButtons()
                correctAnswers.removeAll()
                introText.text = "Who is from Inazuma?"
